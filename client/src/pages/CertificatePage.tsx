      ...
      <div className="bg-canvas-card border border-white/15 rounded-3xl p-6 sm:p-10 shadow-2xl relative overflow-hidden print:border print:border-black print:shadow-none print:bg-white">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pb-6 border-b border-white/10 print:border-black/20">
          ...
          <div className="text-left sm:text-right">
            ...
            <span className="font-mono text-xs font-bold text-bone select-all">{certId}</span>
          </div>
        </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="text-[11px] font-mono text-bone-muted">(Score: {riskScore}/100)</span>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 py-4 text-xs font-mono">
          <div className="p-4 rounded-2xl bg-canvas-elevated/50 border border-white/5 space-y-2.5">
            ...
            <div className="flex justify-between">
              ...
              <span className="text-bone select-all truncate max-w-[170px]">{senderVpa}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-bone-muted">Receiver VPA</span>
              <span className="text-bone select-all truncate max-w-[170px]">{receiverVpa}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-bone-muted">Receiver Name</span>
              <span className="text-bone font-sans font-medium truncate max-w-[170px]">{receiverName}</span>
            </div>
          </div>
          ...
          <div className="p-4 rounded-2xl bg-canvas-elevated/50 border border-white/5 space-y-2.5">
            ...
            <div className="flex justify-between">
              ...
              <span className="text-bone tnum truncate max-w-[170px]">{new Date(timestamp).toLocaleString('en-IN')}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-bone-muted">Geohash Anchor</span>
              <span className="text-bone truncate max-w-[170px]">{geohash}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-bone-muted">Device Attestation</span>
              <span className="text-bone truncate max-w-[170px]">{deviceAttestation}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-bone-muted">Merkle Root</span>
              <span className="text-bone truncate max-w-[170px] select-all">{merkleRoot}</span>
            </div>
          </div>
        </div>
        ...
        <div className="mt-4 p-5 rounded-2xl bg-canvas border border-white/10 space-y-3.5">
          <div className="flex items-center justify-between">
            ...
            <span className="text-[11px] font-mono text-bone-muted">{algorithm}</span>
          </div>
